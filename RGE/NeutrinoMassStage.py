...
from RGE.FlavorMatchedC5 import flavor_match_from_c5_file
...
def build_neutrino_mass_matrix(
    ...
    *,
    ...
    """Return m_nu = -(v^2 / 2) C5 in the current Weinberg convention."""
...
def run_neutrino_mass_stage(
    ...
    *,
    ...
    mass_path = output_dir / "neutrino_mass_matrix.txt"
    ...
    summary = {
        ...
        "NeutrinoMassMatrixFile": mass_path.name,
        "NeutrinoMassMatrixSymmetric": True,
    }

    summary_path = output_dir / "neutrino_mass_summary.json"
