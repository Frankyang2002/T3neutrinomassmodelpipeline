...
from RGE.FlavorMatchedC5 import extract_t3_loop_kernel
...
def run_numerical_pipeline_stage(
    ...
    initial_path = output_dir / "c5_flavor_matrix_numeric.txt"
    low_path = output_dir / "c5_flavor_matrix_low_scale.txt"
    mass_path = output_dir / "neutrino_mass_matrix_low_scale.txt"
    ...
    summary = {
        ...
        "C5FlavorMatrixNumericFile": initial_path.name,
        "C5FlavorMatrixLowScaleFile": low_path.name,
        "NeutrinoMassMatrixLowScaleFile": mass_path.name,
    }

    summary_path = output_dir / "numerical_rge_summary.json"
