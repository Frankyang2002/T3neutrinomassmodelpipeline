...
"""Create one concise, human-facing report for the complete RGE stage."""
    ...
    *,
    ...
    lines.extend(
        [
            ...
            r"\textbf{Normalization check required.} Earlier function documentation",
            r"stated $m_\nu=-(v^2/2)C_5$, whereas the executed code uses",
            r"$m_\nu=-v^2C_5$. The extracted operator normalization and this",
            r"conversion must be checked together before final phenomenology.",
            r"\end{minipage}}",
            r"\end{center}",
