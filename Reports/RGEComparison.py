...
GLOSSARY_ROWS = (
    ...
    (r"$\lambda_{S_1}^{(A)}$", r"adjoint-type $S_1$ self quartic", r"$-\lambda_{S_1}^{(A)}(S_1^\dagger T^A S_1)(S_1^\dagger T^A S_1)$", r"Only appears where that self-contraction is independent/non-vanishing."),
    (r"$\lambda_{S_2}^{(A)}$", r"adjoint-type $S_2$ self quartic", r"$-\lambda_{S_2}^{(A)}(S_2^\dagger T^A S_2)(S_2^\dagger T^A S_2)$", r"Only appears where that self-contraction is independent/non-vanishing."),
    (r"$\lambda_{12}^{(\times)}$", r"crossed $S_1$--$S_2$ invariant", r"$-\lambda_{12}^{(\times)}(S_1^\dagger S_2)(S_2^\dagger S_1)$", r"Independent crossed contraction used when this quartic is present."),
