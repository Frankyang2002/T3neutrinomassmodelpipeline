...
def write_eft_renormalisable_rge(
    ...
    lines: list[str] = [
        ...
        *paper_notation_key_lines(),
        ...
        r"\begin{equation}",
        r"V(H)=\frac{\lambda_1}{2}(H^\dagger H)^2.",
        r"\end{equation}",
        r"Define",
        r"\begin{equation}",
        ...
        r"-\left(\frac{17}{12}g_1^2+\frac94g_2^2+8g_3^2\right)Y_u,\\[1ex]",
        r"\beta_{Y_d}^{(1)}={}&T Y_d"
        r"+\frac{3}{2}\left(Y_dY_d^\dagger Y_d-Y_uY_u^\dagger Y_d\right)"
        r"-\left(\frac{5}{12}g_1^2+\frac94g_2^2+8g_3^2\right)Y_d,\\[1ex]",
        r"\beta_{Y_e}^{(1)}={}&T Y_e"
        r"+\frac{3}{2}Y_eY_e^\dagger Y_e"
        r"-\left(\frac{15}{4}g_1^2+\frac94g_2^2\right)Y_e.",
        r"\end{align}",
        (
            r"No more Yukawa couplings from coupling with heavy fields"
        ),
        r"\section{Higgs quartic}",
        r"With the scalar-potential normalisation $V(H)=\lambda_1(H^\dagger H)^2/2$:",
        r"\begin{align}",
        r"\beta_{\lambda_1}^{(1)}={}&12\lambda_1^2"
        r"+\lambda_1\left[12\operatorname{Tr}(Y_dY_d^\dagger)"
        r"+4\operatorname{Tr}(Y_eY_e^\dagger)"
        r"+12\operatorname{Tr}(Y_uY_u^\dagger)-9g_2^2-3g_1^2\right]\\",
        ...
        r"&+\frac94 g_2^4+\frac32 g_1^2g_2^2+\frac34 g_1^4.",
        r"\end{align}",
        (
