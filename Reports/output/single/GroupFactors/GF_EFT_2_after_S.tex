...
\begin{document}
\section*{T3 group factors: EFT\_2\_after\_S}
...
\midrule
Scotogenic-dS2-N & $(2,\frac{1}{2})$ & $(1,0)$ & S & none \\
\bottomrule
\end{longtable}
\section*{Decoupling statement}
All dependence on the heavy scalar $S$ and fermion $F$ is contained in the matched boundary value $C_5(\mu_{\mathrm{th}})$.  Below the final threshold the one-loop Weinberg-operator running is the universal SMEFT result.
