...
class RunningResultFiguresTests(unittest.TestCase):
    def _payload(self):
        matrix = {
            "real": [[1e-11, 2e-11, 3e-11], [2e-11, 4e-11, 5e-11], [3e-11, 5e-11, 6e-11]],
            "imag": [[0, 0, 0], [0, 0, 0], [0, 0, 0]],
            "abs": [[1e-11, 2e-11, 3e-11], [2e-11, 4e-11, 5e-11], [3e-11, 5e-11, 6e-11]],
        }
        return {
            "status": "Success",
            "scales_gev": {
            ...
            "final_running": {
                "mu_gev": [1e6, 1e4, 1e3],
                "masses_ev": [[0.006, 0.014, 0.075], [0.005, 0.011, 0.06], [0.004, 0.009, 0.05]],
                ...
                "c5_abs": [
                    [[1e-16,2e-16,3e-16],[2e-16,4e-16,5e-16],[3e-16,5e-16,6e-16]],
                    [[9e-17,1.8e-16,2.7e-16],[1.8e-16,3.6e-16,4.5e-16],[2.7e-16,4.5e-16,5.4e-16]],
                    [[8e-17,1.6e-16,2.4e-16],[1.6e-16,3.2e-16,4e-16],[2.4e-16,4e-16,4.8e-16]],
                ],
                "mnu_charged_lepton_abs_ev": [
                    [[0.01,0.02,0.03],[0.02,0.04,0.05],[0.03,0.05,0.06]],
                    [[0.009,0.018,0.027],[0.018,0.036,0.045],[0.027,0.045,0.054]],
                    [[0.008,0.016,0.024],[0.016,0.032,0.040],[0.024,0.040,0.048]],
                ],
            },
            "low_energy": {
                "pmns_abs": [[0.82,0.55,0.15],[0.32,0.66,0.68],[0.47,0.51,0.72]],
