...
class T3TrajectoryTests(unittest.TestCase):
    ...
    def test_weinberg_continuation_uses_scalar_boundary(self) -> None:
        ...
        # Keep this orchestration regression very close to the scalar
        # threshold.  The deliberately synthetic test boundary values are not
        # intended for long-range SM running; this test only verifies that the
        # scalar-threshold state and matched C5 are handed to the Weinberg
        # stage correctly.
