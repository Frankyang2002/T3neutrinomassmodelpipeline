(* TestT3RGBetaRGClosedFull_v2.wl
   Strict A-E smoke test for the class-dependent RG-closed scalar basis.
   Checks not only that returned betas simplify, but also that every expected
   class-dependent coupling is present.
*)
...
ClearAll[HasInternalTensor, HasResidualGroupTensor];
...
Print[""];
Print["================ STRICT RG-CLOSED T3 A-E TEST ================"];
...
Print[""];
Print["STRICT RG-CLOSED T3 A-E TEST: COMPLETE"];
